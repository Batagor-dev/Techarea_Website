...
class PaymentMethodDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('type_payment_method', function ($row) {
                return ucfirst($row->type_payment_method);
            })
            ...
            ->addColumn('action', function ($row) {
                ...
                $edit = '<a href="' . route('payment.edit', $row->uuid) . '"
                ...
                $delete = '
                    <form action="' . route('payment.destroy', $row->uuid) . '" method="POST" style="display:inline-block;" class="delete-form">
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('name_payment_method')
                ->title('Payment Method'),

            Column::make('type_payment_method')
                ->title('Type'),
